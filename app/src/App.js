    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header">🍭 <span className="header-gradient text-glow">Candy Drop</span></p>
          <p className="sub-text text-glow">NFT drop machine with fair mint</p>
          {!walletAddress && renderWhenNotConnected()}
        </div>
        {/* Check for walletAddress and then pas in walletAddress */}
