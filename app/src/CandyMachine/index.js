...
const CandyMachine = ({ walletAddress }) => {
  ...
  const getCandyMachineState = async () => {
    ...
    console.log("ASYNCED", candyMachine)
      ...
      <div className="machine-container">
        ...
        <p>
          <ul className='info-list'>
            <li>{`Items Minted: ${candyMachine.state.itemsRedeemed} / ${candyMachine.state.itemsAvailable}`}</li>
            <li>{`Items Remaining: ${candyMachine.state.itemsRemaining}`}</li>
            <li>{`Price: $${candyMachine.state.price} USD`}</li>
          </ul>
